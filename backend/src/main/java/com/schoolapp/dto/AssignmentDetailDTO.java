...
public class AssignmentDetailDTO {
    ...
    private List<TopLearnerDTO> topLearners;
    private List<LearnerRowDTO> learnerRows;
    ...
    public static class LearnerRowDTO {
        ...
        private int assignmentStars;
        private boolean assignmentStarAwarded;
        ...
        public int getAssignmentStars() { return assignmentStars; }
        public void setAssignmentStars(int assignmentStars) { this.assignmentStars = assignmentStars; }
        public boolean isAssignmentStarAwarded() { return assignmentStarAwarded; }
        public void setAssignmentStarAwarded(boolean assignmentStarAwarded) { this.assignmentStarAwarded = assignmentStarAwarded; }
