...
public class ClassworkDetailDTO {
    ...
    public ClassworkDetailDTO() {}

    // ── Getters & Setters ──

    public String getClassworkId() { return classworkId; }
    public void setClassworkId(String classworkId) { this.classworkId = classworkId; }
    ...
    public static class LearnerRowDTO {
        ...
        private int classworkStars;
        private boolean classworkStarAwarded;
        ...
        public int getClassworkStars() { return classworkStars; }
        public void setClassworkStars(int classworkStars) { this.classworkStars = classworkStars; }
        public boolean isClassworkStarAwarded() { return classworkStarAwarded; }
        public void setClassworkStarAwarded(boolean classworkStarAwarded) { this.classworkStarAwarded = classworkStarAwarded; }
